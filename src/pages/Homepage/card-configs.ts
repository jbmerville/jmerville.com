...
export const SECTION_CONTENT: (ICard.Card | ICard.CardExtra)[] = [
  ...
  },
  {
    ...
    title: {
      primary: 'Genesys Hackathon',
      secondary: 'Fall 2019',
    },
    description:
      'Stalk My Prof is a web application build in React that utilizes the Genesys API and makes the use of machine learning to answer questions about university professors. Finished 3rd out of 20+ teams.',
    image: {
      url: 'genesys.png',
      style: {
        height: '80%',
